    ...
    render() {
        return (
            <div className="container col-md-6">
                ...
                <h1>Réactions politiques à la suite du décès de Serge Dassault</h1><br/><br/>
    
                <p>Paris (AFP) - Voici de nouvelles réactions politiques à la suite du décès de Serge Dassault, survenu lundi à Paris, à l'âge de 93 ans:
...
- Laurent Wauquiez, président de LR: "Grand capitaine d'industrie, à la tête d'entreprises qui font la fierté de notre pays, Serge Dassault était un ardent défenseur du patriotisme industriel. Il était également un homme de convictions: Gaulliste, membre du RPR, puis de l?UMP et des Républicains, il a toujours eu à c?ur de défendre nos valeurs dans le cadre des mandats que les électeurs lui ont confiés pendant de très nombreuses années" (communiqué).

- Florence Parly, ministre des Armées : "La France perd aujourd'hui un grand capitaine d'industrie. Pendant plus d'un demi-siècle, Serge Dassault a ?uvré au service du succès de l'aéronautique française et a permis à nos armées de bénéficier des meilleurs aéronefs.Dassault Aviation a ainsi conçu quelques-uns des avions et des équipements aéronautiques les plus innovants et les plus performants, qui démontrent chaque jour leur efficacité opérationnelle et contribuent à l'excellence de nos forces (communiqué).
